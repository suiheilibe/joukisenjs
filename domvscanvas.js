...
Wave = enchant.Class.create(enchant.Sprite, {
  initialize: function(ww1, ww2, wv1, wv2, wsp1, wsp2) {
    ...
    this.wsp1 = wsp1;
    this.wsp2 = wsp2;
    enchant.Sprite.call(this, Constants.width, Constants.height);
    ...
    this.ws = new WaveSurface(this.wys, this.wwidth + this.wsp);
    this.wx = 0;
    this.image = new enchant.Surface(Constants.width, Constants.height);
    this.x = 0;
    this.y = 0;
  ...
  proc: function() {
    this.wx -= this.wsp;
    if (this.wx + this.wwidth <= 0) {
      this.wx = this.wwidth;
    }
    this.image.clear();
    this.image.draw(this.ws, this.wx, 0);
  }
});
