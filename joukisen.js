...
(function() {
  "use strict";
  var Constants, Sight, StageVars, TheGame, TheShip, TheStage, Wave, WaveSurface;
  ...
  TheStage = Class.create(Scene, {
    initialize: function() {
      ...
      return this.addEventListener('touchend', function(e) {
